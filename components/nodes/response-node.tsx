    ...
    >
      ...
      {/* <div className="space-y-2 text-xs">
        <div className="flex items-center gap-2">
          <div className="font-medium w-16">Status:</div>
          <div className="px-2 py-0.5 bg-orange-100 text-orange-700 rounded font-mono">
            {data.statusCode}
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="text-gray-700 truncate">{data.responseType}</div>
        </div>

        <div className="font-medium mt-1">Response Body:</div>
        <div className="border rounded bg-gray-50 p-2 font-mono text-xs max-h-24 overflow-y-auto whitespace-pre-wrap">
          {data.responseBody || "{}"}
        </div>

        <div className="font-medium mt-1">Resolved Output:</div>

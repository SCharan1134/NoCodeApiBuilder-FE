...
export const schemaApi = {
  createSchema: async (
    ...
    const response = await api.post(`/api/schema/${tenant}/${projectId}`, data);
  ...
  getSchema: async (
    ...
    const response = await api.get(
      `/api/schema/${tenant}/${projectId}/${collectionName}?provider=${provider}`
    );
    return response.data;
  },
  ...
  updateSchema: async (
    ...
    const response = await api.put(
      `/api/schema/${tenant}/${projectId}/${collectionName}`,
      data
    );
    return response.data;
  },
  ...
  getAllCollections: async (
    ...
    const response = await api.get(
      `/api/schema/${tenant}/${projectId}/collections/all?provider=${provider}`
    );
    return response.data;
  },
  ...
  getCollectionParameters: async (
    ...
    const response = await api.get(
      `/api/schema/${tenant}/${projectId}/collections/${collectionName}/parameters?provider=${provider}`
    );
    return response.data;
  },
  ...
  getAllCollectionParameters: async (
    ...
    const response = await api.get(
      `/api/schema/${tenant}/${projectId}/collections/parameters?provider=${provider}`
    );
    return response.data;
  },
};
